...
df = pd.read_csv('../data/manual/processed_hybrid_data_AZ.csv', header=0, parse_dates=[0])
#df_static = 
print(df.head())
...
multi_step_model.add(tf.keras.layers.LSTM(32, activation='relu',dropout=0.5))
...
multi_step_model.save('../checkpoint/model_AZ_hybrid_data.h5')   
#
#
